    ...
    <div className="relative w-full h-screen bg-pure-white overflow-hidden flex items-center justify-center pt-12 md:pt-20">
      ...
      <div className="relative z-20 px-6 max-w-5xl mx-auto text-center flex flex-col items-center">
        <motion.div
           ...
           className="px-4 py-2 md:px-8 md:py-3 rounded-full border-2 border-corporate-blue/40 bg-white/80 backdrop-blur-2xl text-corporate-blue text-[10px] sm:text-sm md:text-xl lg:text-2xl font-black tracking-widest md:tracking-[0.25em] uppercase mb-6 md:mb-12 shadow-[0_10px_30px_rgba(0,80,255,0.1)] inline-block group hover:scale-105 transition-transform cursor-default"
        >
        ...
        <motion.h1 
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-heading leading-[1.1] mb-6 md:mb-8 relative"
        >
        ...
        <motion.p 
          ...
          className="text-base sm:text-lg md:text-2xl text-body max-w-3xl font-medium mb-8 md:mb-12 leading-relaxed"
        >
        ...
        <motion.div 
          ...
          className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 w-full justify-center px-4"
        >
          <Link href="/pricing" className="w-full sm:w-auto">
            <ShinyButton variant="primary" className="text-base md:text-lg px-8 py-4 md:px-10 md:py-5 w-full">Evaluate My Vehicle</ShinyButton>
          </Link>
